...
- This document is the canonical product white paper and product contract.
- The repository `README.md` is a short entry point and documentation index.
- Repository documents are authoritative for durable product, architecture,
  evaluation, and implementation contracts.
- Linear is authoritative for execution state: milestones, issues, decisions,
  review notes, completion receipts, and links to exact repository evidence.
- Linear documents summarize and link to repository contracts; they do not
  duplicate the full normative prose.
- Chat history and model output are context, not proof of implemented behavior.
...
matrix live in
[`../architecture/pricing-usage-and-environment-contract.md`](../architecture/pricing-usage-and-environment-contract.md).
...
[`../architecture/system-architecture-and-decision-records.md`](../architecture/system-architecture-and-decision-records.md).
...
is maintained in
[`../architecture/code-organization-and-contract-registry.md`](../architecture/code-organization-and-contract-registry.md).
...
review form live in
[`../evaluation/m0-evaluation-contract.md`](../evaluation/m0-evaluation-contract.md).
